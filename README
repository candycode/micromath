...
MicroMath+ is copyright (c) Ugo Varetto


Features:
	 - transforms a mathematical expression into RPN form
...
NOTE: 
    ...
    but is far from optimal in case of multi-dimensional operands, I'm
